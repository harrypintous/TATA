...
#spark.sql("CREATE TABLE IF NOT EXISTS DimCurrency(CurrencyKey INT,CurrencyAlternateKey CHAR(3),CurrencyName VARCHAR(50)) COMMENT 'DimCurrency details' ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' STORED AS TEXTFILE")
